...
const useFormField = () => {
  ...
  const lineNumberContext = React.useContext(FormFieldErrorContext)
  const { getFieldState, formState } = useFormContext()

  const fieldState = getFieldState(lineNumberContext.name, formState)
